...
class Cleanser < Formula
  ...
  bottle do
    root_url "https://github.com/phpfc/cleanser/releases/download/v0.7.5"
    rebuild 26
    sha256 cellar: :any_skip_relocation, arm64_sequoia: "8fd0d5e73d73e2101fb1623344f0a35b02ffe20cb74503ea44e901743071ce7a"
  end
